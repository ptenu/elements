...
@Component({
  tag: 'ptu-password-input',
  styleUrl: 'ptu-password-input.css',
  shadow: false,
})
export class PtuPasswordInput {

  @Prop() name: string;
  @Prop() label: string | null;
  @Prop() initialValue: string | null = null;
  @Prop() type = "password";
  @Prop() autocomplete: string = "one-time-code";
      ...
      <Host style={{maxWidth: (this.width + 3) + 'ch', width: '100%'}}>
        <div class="input-wrapper">
          <input id={this.name + `__input`}
                 type={this.isHidden ? this.type : "text"}
                 name={this.name}
