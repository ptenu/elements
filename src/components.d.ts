...
export interface PtuSelectOptionCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLPtuSelectOptionElement;
}
declare global {
    ...
    interface HTMLPtuSelectElement extends Components.PtuSelect, HTMLStencilElement {
    }
    var HTMLPtuSelectElement: {
        prototype: HTMLPtuSelectElement;
        new (): HTMLPtuSelectElement;
    };
    interface HTMLPtuSelectOptionElementEventMap {
        "toggleOption": { value: string, text: string };
    }
    interface HTMLPtuSelectOptionElement extends Components.PtuSelectOption, HTMLStencilElement {
        addEventListener<K extends keyof HTMLPtuSelectOptionElementEventMap>(type: K, listener: (this: HTMLPtuSelectOptionElement, ev: PtuSelectOptionCustomEvent<HTMLPtuSelectOptionElementEventMap[K]>) => any, options?: boolean | AddEventListenerOptions): void;
        addEventListener<K extends keyof DocumentEventMap>(type: K, listener: (this: Document, ev: DocumentEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
        addEventListener<K extends keyof HTMLElementEventMap>(type: K, listener: (this: HTMLElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
        addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
        removeEventListener<K extends keyof HTMLPtuSelectOptionElementEventMap>(type: K, listener: (this: HTMLPtuSelectOptionElement, ev: PtuSelectOptionCustomEvent<HTMLPtuSelectOptionElementEventMap[K]>) => any, options?: boolean | EventListenerOptions): void;
        removeEventListener<K extends keyof DocumentEventMap>(type: K, listener: (this: Document, ev: DocumentEventMap[K]) => any, options?: boolean | EventListenerOptions): void;
        removeEventListener<K extends keyof HTMLElementEventMap>(type: K, listener: (this: HTMLElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | EventListenerOptions): void;
        removeEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | EventListenerOptions): void;
    }
    var HTMLPtuSelectOptionElement: {
        prototype: HTMLPtuSelectOptionElement;
        new (): HTMLPtuSelectOptionElement;
    };
...
declare namespace LocalJSX {
    ...
    interface PtuSelectOption {
        "onToggleOption"?: (event: PtuSelectOptionCustomEvent<{ value: string, text: string }>) => void;
        "selected"?: boolean;
        "text"?: string | null;
        "value"?: string;
    }
